...
<head>
    ...
    <title>Link Accounts - Kwaku Bank</title>
    ...
    <div class="container-fluid py-4" style="width: 85%; margin-left: auto; margin-right: auto;">
        <div class="main-card">
            ...
            <div class="text-center mb-5">
                ...
                <h2 class="fw-bold text-dark mb-3">Move Funds</h2>
                <p class="form-description">
                    Move Funds allows users to securely transfer money between their own accounts or to other
                    beneficiaries. Whether it’s moving money from savings to current, paying bills, or sending funds to
                    friends and family, transactions are fast, reliable, and protected with advanced security measures.
                </p>
            </div>
    ...
    <div class="left-drawer" id="leftDrawer">
        ...
        <div class="drawer-content">
            ...
            <div class="drawer-item">
                ...
                <span><a class="nav-link" href="{{ route('help-support') }}">Help & Support</a></span>
