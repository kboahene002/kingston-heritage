        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <ul class="nav nav-tabs border-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('link-accounts') }}">Link Accounts</a>
                    </li>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container-fluid py-4" style="width: 85%; margin-left: auto; margin-right: auto;">
        <div class="main-card">
            ...
            <div class="text-center mb-5">
                ...
                <h2 class="fw-bold text-dark mb-3">Link Internal Account</h2>
                <p class="form-description">
                    Connect your Internal bank account to easily transfer funds and manage all your accounts in one
                    place.
                    This process is secure and encrypted for your protection.
                </p>
            </div>
